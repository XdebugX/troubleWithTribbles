...
public class CreditsScreen implements Screen, InputProcessor {
	...
	private void sizes () {
		...
		do {
			z=z+0.1f;
			bfD.setScale(z);
			glphLay = new GlyphLayout (TH.bf,creditText[1]);
			a=glphLay.width;
			breaker++;
		...
		float creditsSpacing,sectionSpacing,storySpacing;
		sectionSpacing = (GV.h-logoH)/3;
		creditsSpacing = sectionSpacing / 4;
